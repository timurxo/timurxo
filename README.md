...
⚙️ I specialize in:
- Frontend architectures with **Angular**
- Backend systems using **Java**
- Performance tuning, scalability & clean system design

🧠 I care deeply about **code quality, scalability, and long-term maintainability**
...
## 🧩 What I Build
- 🏗 Enterprise-grade platforms handling **high traffic & complex workflows**
- ⚡ Low-latency systems with focus on **performance optimization**
- 🧼 Clean, maintainable codebases that scale with teams and users
